      ...
      <div class="container">
        ...
        <div class="row no-gutters block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="sendmail.php" method="POST" class="bg-light p-5 contact-form">
              ...
              <div class="form-group">
                <input name="send" type="submit" value="Send Message" class="btn btn-secondary py-3 px-5">
              </div>
            </form>
        ...
        <div class="row d-flex contact-info mb-5 mt-5">
